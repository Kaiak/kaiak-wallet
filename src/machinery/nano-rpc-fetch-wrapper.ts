...
import {
    ...
    AccountHistoryResponse, AccountsFrontiersRequestActionEnum,
...
export function getPendingBlocksSimple(
    ...
    return nanoApi.accountsPending({
...
export function loadBlocks(frontiers: string[]): Promise<{ [key: string]: BlockInfo; }> {
    return nanoApi.blocksInfo({
        blocksInfoRequest: {
