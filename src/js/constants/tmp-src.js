const SRC_BASE = "src"
const TMPL_SRC_BASE = SRC_BASE + "/tmpl";
const TMPL_VIEWS_BASE = TMPL_SRC_BASE + "/views";
const TMPL_COMP_BASE = TMPL_SRC_BASE + "/components";

const TMPL_VIEW_SRC_RECEIVE = TMPL_VIEWS_BASE + "/receive";
const TMPL_VIEW_SRC_RECEIVE_HTML = TMPL_VIEW_SRC_RECEIVE + "/receive.html"

const TMPL_VIEW_SRC_SETUP = TMPL_VIEWS_BASE + "/setup";
const TMPL_VIEW_SRC_SETUP_HTML = TMPL_VIEW_SRC_SETUP + "/setup.html"

const TMPL_VIEW_SRC_MENU = TMPL_VIEWS_BASE + "/menu";
const TMPL_VIEW_SRC_MENU_HTML = TMPL_VIEW_SRC_MENU + "/menu.html"

const TMPL_VIEW_SRC_BALANCE = TMPL_VIEWS_BASE + "/balance";
